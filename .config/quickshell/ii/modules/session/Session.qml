            ...
            ColumnLayout { // Content column
                ...
                GridLayout {
                    ...
                    SessionActionButton {
                        ...
                        onClicked:  { Quickshell.execDetached(["bash", "-c", `systemctl poweroff --no-wall || loginctl poweroff`]); sessionRoot.hide() }
                        onFocusChanged: { if (focus) sessionRoot.subtitle = buttonText }
                    ...
                    SessionActionButton {
                        ...
                        onClicked:  { Quickshell.execDetached(["bash", "-c", `reboot --no-wall || loginctl reboot`]); sessionRoot.hide() }
                        onFocusChanged: { if (focus) sessionRoot.subtitle = buttonText }
